...
| 1.3 | **Compliance Evidence Pack exporter** with **OSCAL backbone**. Frameworks shipped: NCA ECC-1 / ECC-2, SAMA Cyber Security Framework, UAE NESA / TDRA, ADHICS v2, Qatar NCSF, Bahrain CBB module, Kuwait CITRA, Oman OCERT, NIST CSF 2.0, ISO 27001:2022 A.5.7, PCI-DSS 4.0.1, SOC 2 CC7.3. Per-tenant framework selector. **Bilingual toggle** — Arabic exec-summary + English technical body for regulator-facing exports. | 8d | The single most sellable feature for GCC compliance buyers. |
| 1.4 | **Iran-APT TTP overlay** — pre-baked MITRE Navigator layer for APT33 / APT34 / APT35 / MuddyWater / DEV-0270 / Cyber Av3ngers; auto-applied when those actors fire. | 1d | "Show APT34 coverage on my estate" demo wow moment. |
| 1.5 | **GCC ransomware DLS filter** — auto-tag victim posts on RansomHub / Akira / Play / Qilin / LockBit-successor / BlackSuit / Hunters Intl / INC Ransom against `.sa/.ae/.qa/.kw/.bh/.om/.eg` + Arabic company-name fuzz match. | 1d | Regional victim awareness ahead of ransomware groups' own announcements. |
